...
This plan outlines a sequence of distinct sessions meant to be executed by fresh AI agents. To ensure continuity and context, each agent will read `README.md` and keep shared state in `tmp/new_feature_state-<feature_name>.md`.
...
- **Context Establishment:** Read `README.md` and review project structure. Establish the `tmp/new_feature_state-<feature_name>.md` file to store progress.
...
- **Context Check:** Read `README.md` and the `tmp/new_feature_state-<feature_name>.md` notes.
...
- **Context Check:** Read `README.md` and `tmp/new_feature_state-<feature_name>.md`.
...
- **Final Cleanup:** Remove `tmp/new_feature_state-<feature_name>.md` and any other ad-hoc temp files created during execution. Leave the codebase ready for a final manual test run.
